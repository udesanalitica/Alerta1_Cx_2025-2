...
La distribución por departamentos de procedencia de los estudiantes se refleja en el mapa de Colombia.

```{r echo=FALSE, message=FALSE, warning=FALSE}
library(htmltools)

tags$iframe(
  src = "https://public.tableau.com/views/CaracterizacionrecieningresoUDES2021-1y2021-2/Lugardeprocedencia?:embed=yes&:showVizHome=no",
  width = "100%",
  height = "800",
  frameborder = "0",
  allowfullscreen = NA
