...
### Si su respuesta anterior fue sí, indique la edad en la que empezó a fumar
...
### Si su respuesta anterior fue sí, indique la edad que empezó a consumir alcohol por primera vez
...
fig <- plot_ly(
  ...
  layout(
    title = "Distribución nivel educativo más alto \nalcanzado por su madre por campus",
    updatemenus = list(
      list(
        type = 'dropdown',
        active = 0,
...
### Si su respuesta anterior fue sí ¿Cuántas veces a la semana ingiere alcohol?
...
### Si su respuesta fue sí, ¿en qué ocasiones lo hace?
...
### Si su respuesta anterior fue sí, mencione cuáles ha usado
...
### ¿Si su respuesta anterior fue otro (género), indique cuál? \*
...
### Si su respuesta anterior fue otra, indique la orientación sexual

### ¿Padece de alguna enfermedad diagnosticada que requiere tratamiento actualmente?

### Por favor indique qué tipo de enfermedad padece actualmente
